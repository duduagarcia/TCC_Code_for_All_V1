    ...
    <header>
        ...
        <nav>
            ...
            <div class="links-nav">
                ...
                <a href="autentica-adm.html">ADMINISTRAÇÃO</a>
        ...
        <div class="container-form">
            <form  method="post">
                <div class="textfields-container">
                    ...
                    <input type="text" name="nome" id="campo-nome" placeholder="Digite seu nome" required value="<?php   echo $nomeProfessor;?>" readonly="true">
                    <label for="campo-email">Digite seu e-mail:</label>
                    <input type="email" name="email" id="campo-email" placeholder="Digite seu email" required value="<?php   echo $emailProfessor;?>" readonly="true">
